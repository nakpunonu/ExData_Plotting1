...
with(sub.hpc, plot(datetime,Global_active_power,type="n",
                   xlab="",ylab="Global Active Power (kilowatts)")) ##Set up blank plot

with(sub.hpc, lines(datetime,Global_active_power)) ##add lines
